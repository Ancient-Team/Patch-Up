    ...
    public static final ItemGroup PATCH_UP_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.patchup_group"))
                    .icon(() -> new ItemStack(Trims.NAVY_TERRACOTTA_TRIM)).entries((displayContext, entries) -> {
                        ...
                        /* Paper Lanterns */
                        entries.add(PaperLantern.MAROON_PAPER_LANTERN);
                        entries.add(PaperLantern.ROSE_PAPER_LANTERN);
                        entries.add(PaperLantern.CORAL_PAPER_LANTERN);
                        entries.add(PaperLantern.GINGER_PAPER_LANTERN);
                        entries.add(PaperLantern.TAN_PAPER_LANTERN);
                        entries.add(PaperLantern.BEIGE_PAPER_LANTERN);
                        entries.add(PaperLantern.AMBER_PAPER_LANTERN);
                        entries.add(PaperLantern.OLIVE_PAPER_LANTERN);
                        entries.add(PaperLantern.FOREST_PAPER_LANTERN);
                        entries.add(PaperLantern.VERDANT_PAPER_LANTERN);
                        entries.add(PaperLantern.TEAL_PAPER_LANTERN);
                        entries.add(PaperLantern.MINT_PAPER_LANTERN);
                        entries.add(PaperLantern.AQUA_PAPER_LANTERN);
                        entries.add(PaperLantern.SLATE_PAPER_LANTERN);
                        entries.add(PaperLantern.NAVY_PAPER_LANTERN);
                        entries.add(PaperLantern.INDIGO_PAPER_LANTERN);
                        /* Shingles */
                        ...
                        entries.add(StainedBarredGlass.MAROON_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.ROSE_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.CORAL_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.GINGER_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.TAN_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.BEIGE_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.AMBER_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.OLIVE_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.FOREST_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.VERDANT_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.TEAL_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.MINT_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.AQUA_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.SLATE_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.NAVY_STAINED_BARRED_GLASS);
                        entries.add(StainedBarredGlass.INDIGO_STAINED_BARRED_GLASS);
                        /* Stained Barred Glass Pane */
                        entries.add(StainedBarredGlassPane.MAROON_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.ROSE_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.CORAL_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.GINGER_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.TAN_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.BEIGE_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.AMBER_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.OLIVE_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.FOREST_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.VERDANT_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.TEAL_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.MINT_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.AQUA_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.SLATE_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.NAVY_STAINED_BARRED_GLASS_PANE);
                        entries.add(StainedBarredGlassPane.INDIGO_STAINED_BARRED_GLASS_PANE);
                        /* Terracotta Bricks */
                        entries.add(TerracottaBricks.MAROON_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.MAROON_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.MAROON_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.ROSE_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.ROSE_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.ROSE_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.CORAL_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.CORAL_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.CORAL_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.GINGER_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.GINGER_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.GINGER_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.TAN_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.TAN_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.TAN_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.BEIGE_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.BEIGE_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.BEIGE_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.AMBER_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.AMBER_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.AMBER_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.OLIVE_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.OLIVE_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.OLIVE_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.FOREST_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.FOREST_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.FOREST_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.VERDANT_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.VERDANT_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.VERDANT_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.TEAL_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.TEAL_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.TEAL_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.MINT_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.MINT_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.MINT_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.AQUA_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.AQUA_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.AQUA_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.SLATE_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.SLATE_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.SLATE_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.NAVY_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.NAVY_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.NAVY_TERRACOTTA_BRICK_SLAB);
                        entries.add(TerracottaBricks.INDIGO_TERRACOTTA_BRICKS);
                        entries.add(TerracottaBricks.INDIGO_TERRACOTTA_BRICK_STAIRS);
                        entries.add(TerracottaBricks.INDIGO_TERRACOTTA_BRICK_SLAB);
                        /* Tiles */
